...
import ar.edu.undec.nortia.controller.TipofinanciamientoFacade;
...
@ManagedBean(name = "tipofinanciamientoController")
@SessionScoped
public class TipofinanciamientoController implements Serializable {
    ...
    @EJB
    private ar.edu.undec.nortia.controller.TipofinanciamientoFacade ejbFacade;
    ...
    private TipofinanciamientoFacade getFacade() {
        return ejbFacade;
    }
