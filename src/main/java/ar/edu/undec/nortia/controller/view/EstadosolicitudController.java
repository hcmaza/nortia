...
public class EstadosolicitudController implements Serializable {
    ...
    private Estadosolicitud current;
    private DataModel items = null;
    @EJB
    private ar.edu.undec.nortia.controller.EstadosolicitudFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Estadosolicitud) getItems().getRowData();
    ...
    public static class EstadosolicitudControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estadosolicitud) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Estadosolicitud.class.getName());
            }
        }
