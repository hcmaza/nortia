...
public class EstadoproyectoController implements Serializable {
    ...
    @EJB
    private ar.edu.undec.nortia.controller.EstadoproyectoFacade ejbFacade;
    ...
    public SelectItem[] getItemspersonalizado(Boolean x) {
        return JsfUtil.getSelectItems(ejbFacade.finporProyecto(x), false);
    }
